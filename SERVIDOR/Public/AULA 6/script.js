...
// let resp_ex1 = "Olá" + nome + ",seu ano de nascimento é" + ano_nascimento + "!";
// document.getElementById("Exemplo1").innerHTML = resp_ex1;
// Exemplo 2:
function imprimeFrase(frase){
    document.getElementById("ex_f").innerHTML = frase
}
imprimeFrase("PIKA DE MEL");
// função soma:
function  soma(a, b){
   return a + b;
}
...
// function ex2(){
//     let nun = document.getElementById("ex2_num").value;
    
//     let resp = ""
//     console.log("resposta ex 2");
//     for(let i = 0; i < nun; i++){
//         console.log(i);
//         resp+= i+ "";
//     }
